...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e28cd114a5805deb4b01e6cc70b126063951236a9efc613688e967e8fcf92f4a.js',function(){input.required=false;search();});}
