...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.de56c0049912010b10d25eb2b185bad77709984919e8090a76d72c6776e6199a.js',function(){input.required=false;search();});}
