...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.802b4b86c58ff5f798fe713d5264a4e220c53a79c7d1d7dbcbbecc139366660d.js',function(){input.required=false;search();});}
